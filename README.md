...
- This is the key element in the solution as it provides a way to detect objects without having to custom code a TensorFlow app in either Android or RPi Python. Both these other options are technically challenging for hobbyists
