...
At the time of writing (Feb 2021) there are no 'off the shelf' official or third party sensors (that I am aware of!) that deliver an object detection capability for the Lego Mindstorms 51515 set. An object detection camera capability is available for the EV3 system by the third party [Pixy2 camera](https://pixycam.com/pixy2/). In fact, this EV3 solution using the Pixy camera was the inspiration for the current project:
